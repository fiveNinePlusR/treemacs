 ...
 * RET runs a default action, configurable to your tastes under ~treemacs-RET-actions-config~
...
| RET     | treemacs-RET-action                         | Run the action defined in treemacs-RET-actions-config for the current button.                                                                                             |
