 ...
 * TAB and RET are particularly configurable. See ~treemacs-TAB/RET-actions-confg~.
 ...
 * The extended variant highlights both files and directories. This greatly increases the complexity and length of the
   parsing process, and is therefore done in a python process or the sake of performance. The extended variant will thus
   not work without python.
...
| treemacs-RET-actions-config         | Setup to prefer opening nodes             | Defines the behaviour of ~treemacs-RET-action~ based on the current node.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| treemacs-TAB-actions-config         | Setup to prefer expanding & closing nodes | Defines the behaviour of ~treemacs-TAB-action~ based on the current node                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| treemacs-recenter-after-file-follow | t                                         | When non-nil ~recenter~ will be called when ~treemacs-follow-mode~ moves to a new file.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| treemacs-recenter-after-tag-follow  | t                                         | When non-nil ~recenter~ will be called when ~treemacs-tag-follow-mode~ moves to a new tag.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| mouse1  | treemacs-click-mouse1                       | Do the same as ~treemacs-toggle-node~ when mouse1-clicking on an line.                                                                  |
